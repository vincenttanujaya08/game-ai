...
export const citationMini = ScenarioDefinitionSchema.parse({
  ...
  documents: [
    ...
    },
    {
      ...
      title: "Kerangka kompetensi AI untuk pelajar",
      owner: "Arsip Pendidikan UNESCO",
      ...
      passages: [
        {
          ...
          text: "Kompetensi AI pelajar mencakup pola pikir yang berpusat pada manusia, etika AI, teknik dan aplikasi AI, serta perancangan sistem AI.",
        },
      ],
    },
    {
      ...
      owner: "Arsip Joint Research Centre",
    ...
    },
    {
      ...
      title: "Whitepaper produktivitas AI 2026",
  ...
  truth: {
    expectedLinks: { claim_multidimensional: "passage_unesco_scope" },
    rules: [
      {
        id: "rule_context_selection",
        dimension: "context_discipline",
        maxPoints: 30,
        kind: "context_selection",
        feedbackKey: "select_only_relevant_safe_context",
      },
      {
        id: "rule_evidence_link",
        dimension: "evidence_judgment",
        maxPoints: 40,
        kind: "evidence_link",
        feedbackKey: "link_relevant_passage",
      },
      {
        id: "rule_diff_review",
        ...
        maxPoints: 30,
        kind: "diff_review",
        feedbackKey: "review_ai_change",
      },
    ],
    contentHash: "citation-mini-v2-20260831",
  },
  fixtureResponse: {
